...
public class AppAdvisorFunctions {
    ...
    public Function<Map<String, Object>, Mono<McpSchema.CallToolResult>> advisorBuildConfigGetFunction() {
        return arguments -> {
    ...
    public Function<Map<String, Object>, Mono<McpSchema.CallToolResult>> advisorUpgradePlanGetFunction() {
        return arguments -> {
            String pathToSourceCode = (String) arguments.get("pathToSourceCode");
    ...
    public Function<Map<String, Object>, Mono<McpSchema.CallToolResult>> advisorUpgradePlanApplyFunction() {
        return arguments -> {
            String pathToSourceCode = (String) arguments.get("pathToSourceCode");
    ...
    private Mono<McpSchema.CallToolResult> executeCommand(String command) {
        ...
        try {
            ...
            return Mono.just(new McpSchema.CallToolResult(List.of(
        ...
        return Mono.just(new McpSchema.CallToolResult(List.of(new McpSchema.TextContent(output.toString())), isError));
    }
}
